...
const RATING_TYPE = "blitzRating"; // Blitz Rating key
let allPlayers = [];
...
window.openProfile = function(docId) {
  ...
  const playerContent = p.roles?.ratedPlayer ? `
    <div class="profile-detail-row"><span class="profile-detail-label">Blitz Rating</span><span class="profile-detail-value rating-highlight">${pl.stdRating||"—"}</span></div>
