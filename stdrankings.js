...
const RATING_TYPE = "stdRating"; // Standard Rating key in player object
let allPlayers = [];
...
window.openProfile = function(docId) {
  ...
  const playerContent = p.roles?.ratedPlayer ? `
    <div class="profile-detail-row"><span class="profile-detail-label">Std Rating</span><span class="profile-detail-value rating-highlight">${pl.stdRating||"—"}</span></div>
